...
* **APNs Authentication Key**: Firebase Cloud Messaging will use APNs Authentication KEY to connect with APNs. The APNs key is a .p8 file that is provided by Apple in the client [Apple Developer Account](https://developer.apple.com/help/account/) at `Certificates, Identifiers & Profiles`.
